...
manager1.agregarEvento('Ver segunda temporada de Loki', 'Disney+', 800, 2, new Date('2023-10-06'));
manager1.agregarEvento('Cena con mi novia', 'Holly Posadas', 3000, 2, new Date() );
